...
| SGMII PHY 链路 | 通过 GTX 将 M88E1111 接入以太网 MAC | 是 | BLOCKED：PHY 端已追至 MCON J6 B26/B27/A26/A27；与核心板 HT2 对照出现接触点冲突，未找到可证明的 MGT116 lane、GT 端极性、参考频率、strap/MDIO 地址 | sgmii-link | 链路状态、MDIO 读回、SGMII/PCS 锁定 | PLANNED |
