...
| SGMII PHY 链路 | 通过 GTX 将 M88E1111 接入以太网 MAC | 是 | 部分确认：`J6 B26/B27 → HT2 A25/A26 → MGT116_TX3_N/P`，`J6 A26/A27 → HT2 B25/B26 → MGT116_RX3_N/P`；lane 3、方向和极性已确认。参考频率、strap/MDIO 地址和复位时序 BLOCKED | sgmii-link | 链路状态、MDIO 读回、SGMII/PCS 锁定 | PLANNED |
