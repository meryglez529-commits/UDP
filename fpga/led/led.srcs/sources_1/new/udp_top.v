...
module udp_top #(
    ...
    parameter [15:0] DATA_LOCAL_UDP_PORT = 16'd32001,
    parameter [15:0] DATA_HOST_UDP_PORT  = 16'd32001,
    parameter integer DATA_MAX_UDP_PAYLOAD = 8972
) (
    ...
    output wire [4:0]  data_rx_fifo_level_o,
    ...
    udp_transport_dual_host #(
        ...
        .HOST_MAC        (HOST_MAC),
        .HOST_IPV4       (HOST_IPV4),
        .CTRL_LOCAL_PORT (LOCAL_UDP_PORT),
        .CTRL_HOST_PORT  (HOST_UDP_PORT),
        .DATA_LOCAL_PORT (DATA_LOCAL_UDP_PORT),
        .DATA_HOST_PORT  (DATA_HOST_UDP_PORT),
        .DATA_MAX_PAYLOAD(DATA_MAX_UDP_PAYLOAD)
    ) udp_transport_i (
        .clk_i                   (link_clock_125m_o),
        .resetn_i                (comm_base_resetn_o),
        .link_ready_i            (link_ready_o),
        .ctrl_soft_resetn_i      (comm_soft_resetn_i),
        .ctrl_channel_resetn_o   (comm_resetn_o),
        ...
        .ctrl_rx_valid_o         (rx_msg_valid_o),
        .ctrl_rx_ready_i         (rx_msg_ready_i),
        .ctrl_rx_data_o          (rx_msg_data_o),
        .ctrl_rx_last_o          (rx_msg_last_o),
        .ctrl_rx_len_o           (rx_msg_len_o),
        .ctrl_tx_valid_i         (tx_msg_valid_i),
        .ctrl_tx_ready_o         (tx_msg_ready_o),
        .ctrl_tx_len_i           (tx_msg_len_i),
        .ctrl_tx_data_valid_i    (tx_msg_data_valid_i),
        .ctrl_tx_data_ready_o    (tx_msg_data_ready_o),
        .ctrl_tx_data_i          (tx_msg_data_i),
        .ctrl_tx_data_last_i     (tx_msg_data_last_i),
        .ctrl_tx_error_o         (tx_msg_error_o),
        .data_rx_valid_o         (data_rx_valid_o),
        .data_rx_ready_i         (data_rx_ready_i),
        .data_rx_data_o          (data_rx_data_o),
        .data_rx_last_o          (data_rx_last_o),
        .data_rx_len_o           (data_rx_len_o),
        .data_tx_req_valid_i     (data_tx_req_valid_i),
        .data_tx_req_ready_o     (data_tx_req_ready_o),
        .data_tx_len_i           (data_tx_len_i),
        .data_tx_valid_i         (data_tx_valid_i),
        .data_tx_ready_o         (data_tx_ready_o),
        .data_tx_data_i          (data_tx_data_i),
        .data_tx_last_i          (data_tx_last_i),
        .data_tx_cancel_valid_i  (data_tx_cancel_valid_i),
        .data_tx_cancel_ready_o  (data_tx_cancel_ready_o),
        .data_tx_status_valid_o  (data_tx_status_valid_o),
        .data_tx_status_ready_i  (data_tx_status_ready_i),
        .data_tx_status_o        (data_tx_status_o),
        .ctrl_rx_level_o         (rx_fifo_level_o),
        .data_rx_level_o         (data_rx_fifo_level_o),
        .tx_busy_o               (tx_busy_o),
