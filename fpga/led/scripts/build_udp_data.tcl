...
set control_top "udp_data_test_top"
set synth_name "synth_udp_data"
set impl_name "impl_udp_data"
...
if {![string match "*Complete*" $synth_status]} {
    error "DATA synthesis did not complete: $synth_status"
}
if {![string match "*Complete*" $impl_status]} {
    error "DATA implementation did not complete: $impl_status"
}
...
puts "RESULT=DB500_DATA_ROUTE_PASSED"
close_design
launch_runs $impl_name -to_step write_bitstream -jobs 4
wait_on_run $impl_name
set impl_status [get_property STATUS [get_runs $impl_name]]
if {![string match "*Complete*" $impl_status]} {
    error "DATA bitstream generation did not complete: $impl_status"
}
...
puts "RESULT=DB500_DATA_BUILD_PASSED"
