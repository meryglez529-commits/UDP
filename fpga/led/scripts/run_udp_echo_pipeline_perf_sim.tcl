...
set_property top udp_echo_pipeline_perf_tb [get_filesets sim_1]
...
set sim_status [catch {
    ...
    close $sim_fd
    if {[string first "RESULT=UDP_ECHO_PIPELINE_PERF_PASSED" $sim_text] < 0} {
        error "UDP echo pipeline performance testbench did not report PASS; inspect $sim_log"
    }
...
puts "RESULT=UDP_ECHO_PIPELINE_PERF_SIM_PASSED"
