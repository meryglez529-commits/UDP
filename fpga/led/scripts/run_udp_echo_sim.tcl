...
set_property top udp_payload_echo_tb [get_filesets sim_1]
...
set sim_status [catch {
    ...
    close $sim_fd
    if {[string first "RESULT=UDP_PAYLOAD_ECHO_PASSED" $sim_text] < 0} {
        error "UDP echo testbench did not report PASS; inspect $sim_log"
    }
...
puts "RESULT=UDP_ECHO_SIM_PASSED"
