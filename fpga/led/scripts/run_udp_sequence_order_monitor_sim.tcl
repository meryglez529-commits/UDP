...
set_property top udp_sequence_order_monitor_tb [get_filesets sim_1]
...
set sim_status [catch {
    ...
    close $sim_fd
    if {[string first "RESULT=UDP_SEQUENCE_ORDER_MONITOR_PASSED" $sim_text] < 0} {
        error "UDP sequence monitor testbench did not report PASS; inspect $sim_log"
    }
...
puts "RESULT=UDP_SEQUENCE_ORDER_MONITOR_SIM_PASSED"
